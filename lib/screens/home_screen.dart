...
import 'chat_screen.dart';  // ✅ Chat Screen
import 'user_bookings_screen.dart'; // ✅ Booking Screen
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  /// ✅ Search Function (Now Works with Treatable Diseases)
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        filteredDoctors = doctors.where((doctor) {
          ...
          final diseaseMatch = doctor.treatableDiseases != null &&
              doctor.treatableDiseases.any(
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 1:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const ChatScreen(doctorName: '',)), // ✅ Chat Screen Activated
        );
        break;
      case 2:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const UserBookingsScreen()), // ✅ Booking Screen Activated
        );
        break;
      case 3:
        Navigator.push(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /// ✅ Bottom Navigation Bar (Updated for Chat & Booking)
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.chat), label: 'Chat'), // ✅ Chat Enabled
          BottomNavigationBarItem(icon: Icon(Icons.calendar_today), label: 'Booking'), // ✅ Booking Enabled
